...
class OnitamaGame(AbstractGame):
    ...
    def _get_possible_moves(self, x: int, y: int, card: OnitamaCard) -> List[Tuple[int, int]]:
    ...
    def make_move(self, move_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Switch player
        self.current_player = OnitamaPiece.BLUE if self.current_player == OnitamaPiece.RED else OnitamaPiece.RED
    ...
    def is_game_over(self) -> bool:
        ...
        if self.board[0, 2] == OnitamaPiece.RED_MASTER.value or \
           self.board[4, 2] == OnitamaPiece.BLUE_MASTER.value:
            return True
