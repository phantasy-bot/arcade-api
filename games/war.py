...
class WarGame(AbstractGame):
    ...
    def make_move(self) -> Dict[str, Any]:
        ...
        # Play cards
        self.current_battle = [
            self._play_card('player'),
            self._play_card('computer')
        ]
    ...
    def get_game_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            ] if self.current_battle else None,
            'war_cards': [
                card.to_dict() for card in self.war_cards
            ],
    ...
    def is_game_over(self) -> bool:
        ...
        return (not self.player_deck or 
                not self.computer_deck or 
