...
class MancalaGame(AbstractGame):
    ...
    def _make_move(self, hole: int) -> bool:
        ...
        if (current in self._get_player_holes(self.current_player) and 
            self.board[current] == 1 and 
    ...
    def other(self) -> 'MancalaPlayer':
        ...
        return MancalaPlayer.PLAYER2 if self.current_player == MancalaPlayer.PLAYER1 else MancalaPlayer.PLAYER1
