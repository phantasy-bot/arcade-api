...
class BSGame(AbstractGame):
    ...
    def _init_game(self):
        ...
        for i in range(self.num_players):
            self.hands[i] = [self.deck.pop() for _ in range(len(self.deck) // self.num_players)]
    ...
    def get_game_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_claim': [card.to_dict() for card in self.last_claim] if self.last_claim else None,
